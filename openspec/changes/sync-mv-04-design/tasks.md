...
- [x] 11.3 補上 `scroll_fade`（高 28、白色由透明漸層，貼齊捲動區底緣，初始狀態 top 662／其餘 717）與 `scrollbar_hint`（寬 4、`#b4b9c4` 50% 透明、圓角 2、距右緣 4，初始狀態高 552／其餘 644）；注意漸層需放在捲動容器之外，否則會跟著內容捲走（同 MV-09 字型選單的處理方式）
